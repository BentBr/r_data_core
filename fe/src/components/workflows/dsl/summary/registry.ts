...
import { createKeyResolver, createPartialKeyResolver, createTypeResolver } from './resolvers'
...
const fromSummaryHandlers: {
    ...
    previous_step: (_from: Extract<NonFormatFrom, { type: 'previous_step' }>, t: TranslateFn) =>
...
const transformSummaryHandlers: {
    ...
    authenticate: (transform: Extract<Transform, { type: 'authenticate' }>, t: TranslateFn) =>
...
export const resolveToFormatOutput = createKeyResolver<
    'api' | 'download' | 'push',
    FormatTo | FormatToPush
>({
