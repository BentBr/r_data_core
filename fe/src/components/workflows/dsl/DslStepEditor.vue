<template>
    <div class="step-editor">
        <v-alert
            ...
            class="mb-4"
        >
            <div class="text-subtitle-2 mb-1">{{ t('workflows.dsl.guidance.step_summary_title') }}</div>
        ...
        <v-card
            ...
            class="mb-4"
        >
            <v-card-title class="text-subtitle-2">{{ t('workflows.dsl.guidance.sections.input_title') }}</v-card-title>
            <v-card-subtitle>
        ...
        <v-card
            ...
            class="mb-4"
        >
            <v-card-title class="text-subtitle-2">{{ t('workflows.dsl.guidance.sections.transform_title') }}</v-card-title>
            <v-card-subtitle>
        ...
        <v-card variant="outlined">
            <v-card-title class="text-subtitle-2">{{ t('workflows.dsl.guidance.sections.output_title') }}</v-card-title>
            <v-card-subtitle>
