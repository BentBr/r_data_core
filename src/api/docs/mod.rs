...
#[openapi(
    ...
    components(
        schemas(
            ...
            crate::api::admin::workflows::routes::WorkflowVersionMeta,
            crate::api::admin::workflows::routes::WorkflowVersionPayload,
            crate::api::admin::entity_definitions::routes::EntityDefinitionVersionMeta,
            crate::api::admin::entity_definitions::routes::EntityDefinitionVersionPayload,
