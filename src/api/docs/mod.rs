...
#[openapi(
    paths(
        crate::api::admin::auth::routes::admin_login,
        crate::api::admin::auth::routes::admin_register,
        crate::api::admin::auth::routes::admin_logout,
        crate::api::admin::auth::routes::admin_refresh_token,
        crate::api::admin::auth::routes::admin_revoke_all_tokens,
        ...
        crate::api::admin::workflows::routes::list_workflow_versions,
        crate::api::admin::workflows::routes::get_workflow_version,
        crate::api::admin::entity_definitions::routes::list_entity_definition_versions,
        crate::api::admin::entity_definitions::routes::get_entity_definition_version,
    ...
    components(
        schemas(
            ...
            crate::api::admin::api_keys::models::CreateApiKeyRequest,
            crate::api::admin::api_keys::models::ApiKeyResponse,
            crate::api::admin::api_keys::models::ApiKeyCreatedResponse,
            crate::api::admin::api_keys::models::ReassignApiKeyRequest,
            crate::api::query::PaginationQuery,
            crate::api::admin::auth::models::AdminLoginRequest,
            crate::api::admin::auth::models::AdminLoginResponse,
            crate::api::admin::auth::models::AdminRegisterRequest,
            crate::api::admin::auth::models::AdminRegisterResponse,
            crate::api::admin::auth::models::EmptyRequest,
            crate::api::admin::auth::models::RefreshTokenRequest,
            crate::api::admin::auth::models::RefreshTokenResponse,
            crate::api::admin::auth::models::LogoutRequest,
            ...
            crate::api::admin::workflows::models::WorkflowVersionMeta,
            crate::api::admin::workflows::models::WorkflowVersionPayload,
            crate::api::admin::entity_definitions::models::EntityDefinitionVersionMeta,
            crate::api::admin::entity_definitions::models::EntityDefinitionVersionPayload,
            crate::api::admin::dsl::models::DslValidateRequest,
            crate::api::admin::dsl::models::DslValidateResponse,
            crate::api::admin::dsl::models::DslFieldSpec,
            crate::api::admin::dsl::models::DslTypeSpec,
            crate::api::admin::dsl::models::DslOptionsResponse,
            crate::api::admin::system::models::EntityVersioningSettingsDto,
            crate::api::admin::system::models::UpdateSettingsBody
        )
    ),
