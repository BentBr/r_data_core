...
#[openapi(
    paths(
        ...
        r_data_core_api::public::dynamic_entities::routes::list_entities,
        r_data_core_api::public::dynamic_entities::routes::create_entity,
        r_data_core_api::public::dynamic_entities::routes::get_entity,
        r_data_core_api::public::dynamic_entities::routes::update_entity,
        r_data_core_api::public::dynamic_entities::routes::delete_entity,
