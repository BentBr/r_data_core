...
use crate::tasks::password_reset_cleanup::PasswordResetCleanupTask;
...
/// Registrar for password reset token cleanup task
pub struct PasswordResetCleanupRegistrar;

impl TaskRegistrar for PasswordResetCleanupRegistrar {
    async fn register(
        &self,
        ...
        let cron = config.refresh_token_cleanup_cron.clone();
