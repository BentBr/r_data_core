...
use crate::tasks::system_logs_purger::SystemLogsPurgerTask;
...
/// Registrar for system logs purger task
pub struct SystemLogsPurgerRegistrar;

impl TaskRegistrar for SystemLogsPurgerRegistrar {
    async fn register(
        &self,
        ...
        let cron = config.system_logs_purger_cron.clone();
        let retention_days = config.system_logs_retention_days;
