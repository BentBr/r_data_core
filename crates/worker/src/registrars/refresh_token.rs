...
use crate::tasks::refresh_token_cleanup::RefreshTokenCleanupTask;
...
/// Registrar for refresh token cleanup task
pub struct RefreshTokenCleanupRegistrar;

impl TaskRegistrar for RefreshTokenCleanupRegistrar {
    async fn register(
        &self,
        ...
        let job = Job::new_async(cron.as_str(), move |_uuid, _l| {
            ...
            Box::pin(async move {
                let task = RefreshTokenCleanupTask::new(cron);
